  ...
  return (
    <div>
      <h2 id="product-category-heading" data-cy="ProductCategoryHeading">
        <Translate contentKey="boutiqueApp.productCategory.home.title">Product Categories</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="boutiqueApp.productCategory.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/product-category/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            ...
            &nbsp;
            <Translate contentKey="boutiqueApp.productCategory.home.createLabel">Create new Product Category</Translate>
          </Link>
        </div>
      </h2>
        ...
        {productCategoryList && productCategoryList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="boutiqueApp.productCategory.id">ID</Translate>{' '}
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="boutiqueApp.productCategory.home.notFound">No Product Categories found</Translate>
            </div>
          )
        )}
      </div>
