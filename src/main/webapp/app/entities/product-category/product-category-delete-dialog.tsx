...
export const ProductCategoryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="boutiqueApp.productCategory.delete.question">
        <Translate contentKey="boutiqueApp.productCategory.delete.question" interpolate={{ id: productCategoryEntity.id }}>
