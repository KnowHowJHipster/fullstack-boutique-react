  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="boutiqueApp.productCategory.home.createOrEditLabel" data-cy="ProductCategoryCreateUpdateHeading">
            <Translate contentKey="boutiqueApp.productCategory.home.createOrEditLabel">Create or edit a ProductCategory</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('boutiqueApp.productCategory.name')}
              ...
              />
              <ValidatedField
                label={translate('boutiqueApp.productCategory.description')}
