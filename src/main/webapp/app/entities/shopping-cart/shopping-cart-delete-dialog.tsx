...
export const ShoppingCartDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="boutiqueApp.shoppingCart.delete.question">
        <Translate contentKey="boutiqueApp.shoppingCart.delete.question" interpolate={{ id: shoppingCartEntity.id }}>
