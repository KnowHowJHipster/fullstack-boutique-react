  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="boutiqueApp.shoppingCart.home.createOrEditLabel" data-cy="ShoppingCartCreateUpdateHeading">
            <Translate contentKey="boutiqueApp.shoppingCart.home.createOrEditLabel">Create or edit a ShoppingCart</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('boutiqueApp.shoppingCart.placedDate')}
              ...
              />
              <ValidatedField
                label={translate('boutiqueApp.shoppingCart.status')}
              ...
              >
                {orderStatusValues.map(orderStatus => (
                  <option value={orderStatus} key={orderStatus}>
                    {translate('boutiqueApp.OrderStatus.' + orderStatus)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                label={translate('boutiqueApp.shoppingCart.totalPrice')}
              ...
              />
              <ValidatedField
                label={translate('boutiqueApp.shoppingCart.paymentMethod')}
              ...
              >
                {paymentMethodValues.map(paymentMethod => (
                  <option value={paymentMethod} key={paymentMethod}>
                    {translate('boutiqueApp.PaymentMethod.' + paymentMethod)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedField
                label={translate('boutiqueApp.shoppingCart.paymentReference')}
              ...
              <ValidatedField
                ...
                label={translate('boutiqueApp.shoppingCart.customerDetails')}
                type="select"
                required
              >
                <option value="" key="0" />
