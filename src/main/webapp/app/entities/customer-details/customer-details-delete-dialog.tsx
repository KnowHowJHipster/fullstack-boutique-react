...
export const CustomerDetailsDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="boutiqueApp.customerDetails.delete.question">
        <Translate contentKey="boutiqueApp.customerDetails.delete.question" interpolate={{ id: customerDetailsEntity.id }}>
