  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="boutiqueApp.product.home.createOrEditLabel" data-cy="ProductCreateUpdateHeading">
            <Translate contentKey="boutiqueApp.product.home.createOrEditLabel">Create or edit a Product</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('boutiqueApp.product.name')}
                id="product-name"
                name="name"
                data-cy="name"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('boutiqueApp.product.description')}
              ...
              />
              <ValidatedField
                label={translate('boutiqueApp.product.price')}
                id="product-price"
                name="price"
                data-cy="price"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('boutiqueApp.product.productSize')}
              ...
              >
                {sizeValues.map(size => (
                  <option value={size} key={size}>
                    {translate('boutiqueApp.Size.' + size)}
                  </option>
                ))}
              </ValidatedField>
              <ValidatedBlobField
                label={translate('boutiqueApp.product.image')}
                id="product-image"
                name="image"
                data-cy="image"
                isImage
              ...
              <ValidatedField
                ...
                label={translate('boutiqueApp.product.productCategory')}
                type="select"
                required
              >
                <option value="" key="0" />
