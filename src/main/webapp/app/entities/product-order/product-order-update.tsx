  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="boutiqueApp.productOrder.home.createOrEditLabel" data-cy="ProductOrderCreateUpdateHeading">
            <Translate contentKey="boutiqueApp.productOrder.home.createOrEditLabel">Create or edit a ProductOrder</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('boutiqueApp.productOrder.quantity')}
              ...
              />
              <ValidatedField
                label={translate('boutiqueApp.productOrder.totalPrice')}
              ...
              <ValidatedField
                ...
                name="product"
                data-cy="product"
                label={translate('boutiqueApp.productOrder.product')}
                type="select"
                required
              >
                <option value="" key="0" />
              ...
              <ValidatedField
                ...
                name="cart"
                data-cy="cart"
                label={translate('boutiqueApp.productOrder.cart')}
                type="select"
                required
              >
                <option value="" key="0" />
