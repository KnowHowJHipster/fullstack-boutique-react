...
export const ProductOrderDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="boutiqueApp.productOrder.delete.question">
        <Translate contentKey="boutiqueApp.productOrder.delete.question" interpolate={{ id: productOrderEntity.id }}>
