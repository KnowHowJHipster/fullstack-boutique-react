...
describe('ProductCategory e2e test', () => {
  ...
  const productCategorySample = { name: 'tensely eek glittering' };
  ...
  describe('new ProductCategory page', () => {
    ...
    it('should create an instance of ProductCategory', () => {
      cy.get(`[data-cy="name"]`).type('scholarly jaw woefully');
      cy.get(`[data-cy="name"]`).should('have.value', 'scholarly jaw woefully');

      cy.get(`[data-cy="description"]`).type('brave the');
      cy.get(`[data-cy="description"]`).should('have.value', 'brave the');
