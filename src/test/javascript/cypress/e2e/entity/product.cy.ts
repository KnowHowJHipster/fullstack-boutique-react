...
describe('Product e2e test', () => {
  ...
  const productSample = { name: 'supposing', price: 12254.73, productSize: 'XXL' };
  ...
  beforeEach(() => {
    ...
    cy.authenticatedRequest({
      ...
      body: { name: 'blah', description: 'pish colonisation alternative' },
    }).then(({ body }) => {
  ...
  describe('new Product page', () => {
    ...
    it('should create an instance of Product', () => {
      cy.get(`[data-cy="name"]`).type('ha duh uh-huh');
      cy.get(`[data-cy="name"]`).should('have.value', 'ha duh uh-huh');

      cy.get(`[data-cy="description"]`).type('fully');
      cy.get(`[data-cy="description"]`).should('have.value', 'fully');

      cy.get(`[data-cy="price"]`).type('12005.31');
      cy.get(`[data-cy="price"]`).should('have.value', '12005.31');
